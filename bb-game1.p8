...
menuitem(1, gone_inside, function()
	for i=0,63 do
		dset(i,0)
	end
	load("bb-intro")
...
function draw_beam(x,y)
	if (rnd() > 0.8) then
		rect(x,y-(56-x), x,y-(56-x) - rnd()*8,rnd()*3 +8)
	end
end
...
-- [ ground floor ]
	...
	obj_front_door = {		
		...
		verbs = {
			lookat = function(me)
				say_line("home sweet..."..(swear and "shitty" or "cheap").." basement apartment.")
			end,
			walkto = function(me)
				come_out_door(me, 
	...
	-- hall
		-- objects
			...
			obj_hall_door_kitchen = {		
				...
				verbs = {
					...
					open = function(me)
						if islit() then
						open_door(me, obj_kitchen_door_hall)
						else
			...
			obj_kitchen_door_hall = {		
				...
				verbs = {
					...
					-- end,
					-- open = function(me)
					-- 	open_door(me,obj_hall_door_kitchen)
					 end
				}
			}
			...
			obj_kitchen_door_bedroom = {
				...
				init = function(me)  
					me.target_door = obj_bedroom_door_kitchen
				end
			}
		...
		obj_stain = {
			...
			verbs = {
				lookat = function()
					if islit() then
						say_line("That's just Ole Stan.:He came with the apartment.")
					else
						toodark()
					end
				end,
		...
		obj_couch = {		
			...
			verbs = {
				lookat = function(me)
					if islit() then
						say_line("it's very, uh,:...curbcore")
					else
						toodark()
					end
			end,
		...
		obj_lightswitch = {		
			...
			verbs = {
				use = function(me)
					...
					--	obj_hall_door_kitchen.lighting = 0
						obj_lightswitch.lighting = 0.6
						me.on = false
					else
						rm_hall.lighting = 1
					--		obj_hall_door_kitchen.lighting = 1
			...
			verbs = {
				lookat = function(me)
					...
					say_line("a brick in the tank to save water -: the least weird thing in the whole place")
						...
						say_line("perfect for saving water or committing small acts of vandalism")
					end
				end,
				pickup=function(me)
					me.state="state_here"
		...
		obj_bus_stop = {
			...
			verbs = {
				lookat = function(me)
					if gone_inside then
						say_line("I *could* just get on the bus and never come back...:start a new life in a new city...")
					else
						say_line("the number 12, picks up every 15 minutes.:there's no joke here. go by transit, kids")
					end
				end,
				use = function(me)
					if gone_inside then
						say_line((swear and "fuck" or "forget").." this, I'm outta here")
						dset(63,1)
						load("bb-ending")
					else
						say_line("I just got home!")
					end
				end
			}
		}
			...
			verbs = {
				walkto = function(me)
					if me.state == "state_open" then
						come_out_door(me, obj_greg_window_inside)
					end
				end,
				lookat = function()
					if not met_greg then
						say_line("that's my roommate's room.:he's kinda creepy.:probably better to not stare in his window.")
					else
						say_line("that's greg's room.")
					end
				end,
				open = function()
					say_line("it won't budge.")
					if met_greg then
						say_line(" I'd have to force it somehow...")
					else
						say_line("maybe I should just go in the front door?")
					end
				end
			}
		...
		rm_hall = {
			...
			exit = function(me)
				stop_script(me.scripts.anim_demon)
				dset(2,me.lighting+1)
			end,
			scripts = {
				anim_demon = function()
					while true do
	...
	rm_outside = {
		...
		enter = function(me)
			if not me.done_intro then
				...
				-- init actor
				put_at(selected_actor, 45, 50, rm_outside)
		...
		exit = function()
			gone_inside = true
			dset(1,1) --position 1, gone_inside, is true
		end
	}
...
function startup_script()	
	-- set ui colors
	reset_ui()
	put_at(demon, 65, 35, rm_hall)
	put_at(greg, 80, 50, rm_kitchen)
...

...

...
__gff__

